...
// A partir de aquí empieza nuestro código personalizado

function drawViz(data) {
  // 1. Limpiar cualquier visualización anterior
  document.body.innerHTML = '';

  // 2. Comprobar si tenemos datos
  ...
  // 3. Extraer el valor de la métrica y las opciones de estilo
  ...
  // 4. Cargar la librería de Google Charts
  ...
  function drawChart() {
    ...
    // 6. Definir las opciones del gráfico
    const options = {
      width: 400,
      height: 240,
      redFrom: minValue,
...
// Usamos objectTransform porque nuestro código está preparado para ese formato.
